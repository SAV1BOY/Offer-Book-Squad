...
| 4 | Eventos & logística | [`events-logistics-coordinator`](../agents/events-logistics-coordinator.md) | [`build-events-logistics`](../tasks/ops/build-events-logistics.md) | [`events-logistics-checklist`](../checklists/events-logistics-checklist.md) | `artifact.events-calendar` (webinar/challenge com sala, ensaio, fallback) |
