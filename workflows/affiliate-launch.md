...
| 2 | Comissão + prêmios | [`affiliate-program-architect`](../agents/affiliate-program-architect.md) | [`build-affiliate-program`](../tasks/growth/build-affiliate-program.md) (ToT comissão) | [`affiliate-program-checklist`](../checklists/affiliate-program-checklist.md) | `artifact.affiliate-prizes`, estrutura de comissão |
...
| 5 | Leaderboard + blackbook | [`affiliate-program-architect`](../agents/affiliate-program-architect.md) | [`build-affiliate-program`](../tasks/growth/build-affiliate-program.md) (leaderboard/blackbook) | [`affiliate-program-checklist`](../checklists/affiliate-program-checklist.md) | `artifact.affiliate-program`, `artifact.affiliate-blackbook` |
